...
public class GestioneFile{
	 ...
	 * Se il parametro append e' true, apre il file in append, altrimenti apre il file in scrittura e lo sovrascrive.
    ...
    /**
	 *Legge il contenuto di un file, il cui nome e' indicato nel costruttore, 
