...
public final class ClientIRC
{
	...
	private class ircGui extends JFrame{
        ...
        public ircGui(){
        	...
        	PanelBasso.add(new JLabel("Modalit� esperti - Scrivi qui direttamente il comando: "));
        	...
        	public void actionPerformed(ActionEvent e){
        		...
        		if(bottone.equals("CONNETTI")){
        			...
        			try{
        				...
        				if(JTFurl.getText().equals("") || JTFnick.getText().equals("") || 
        					...
        					System.out.println("Uno dei campi necessari per la connessione � vuoto");
        					JTAricevuti.append("Uno dei campi necessari per la connessione � vuoto\n\n");
        					return;
        				}
        		...
        		if (bottone.equals("CAMBIA CANALE")){
        			...
        			if(nuovoCanale.equals("")){
        				System.out.println("Il campo canale � vuoto");
        				JTAricevuti.append("\nIl campo canale � vuoto.\n\n");
        			}
        			else{
        				irc.esciChan();
        				canale=nuovoCanale;
